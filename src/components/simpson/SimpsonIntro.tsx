  ...
  return (
    <section className="mb-8 space-y-4">
      ...
      <p className="text-gray-700">
        ...
        recta, Simpson utiliza{" "}
        <span className="font-semibold">parábolas</span>{" "}
      ...
      <p className="text-gray-700">
        Para aplicar Simpson, el intervalo{" "}
        <InlineMath math="[a,b]" /> se divide en un número{" "}
        <span className="font-semibold">par</span> de subintervalos{" "}
        <InlineMath math="n" />, con ancho{" "}
        <InlineMath math="h=\frac{b-a}{n}" />.  
        Tomamos los puntos <InlineMath math="x_0, x_1, \ldots, x_n" /> y
        formamos grupos de tres puntos:{" "}
        <InlineMath math="(x_0, x_1, x_2)" />,{" "}
        <InlineMath math="(x_2, x_3, x_4)" />, etc. Cada grupo define
        una parábola cuya área se calcula exactamente y luego se suman todas
        esas áreas.
      </p>
      ...
      <div className="bg-purple-50 border border-purple-100 rounded-xl p-4 text-sm text-gray-800 space-y-4">
        ...
        <p>
          Sea{" "}
          <span className="font-mono font-black bg-purple-300/80 px-2 py-1 rounded-xl text-purple-700 text-lg">
            <InlineMath math="h = \frac{b-a}{n}" />
          </span>{" "}
        ...
        <div className="font-black text-center text-lg bg-purple-200/80 p-3 rounded-xl text-purple-700">
          <BlockMath
            math={`
        ...
        <div className="text-center bg-purple-200/80 px-2 py-1 rounded-xl text-purple-700 text-lg font-black">
          <BlockMath
            math={`
              1\\cdot f(x_0) + 4\\cdot f(x_1) + 2\\cdot f(x_2) + 4\\cdot f(x_3) + 1\\cdot f(x_4)
            `}
          />
          <p className="font-mono font-semibold mt-1">⟶ &nbsp; 1 &nbsp; 4 &nbsp; 2 &nbsp; 4 &nbsp; 1</p>
        </div>
      ...
      <figure className="bg-white rounded-xl shadow-sm p-4 border border-gray-100">
        ...
        <figcaption className="mt-2 text-xs text-gray-500 text-center">
          ...
          parábola que pasa por los puntos (x₀, f(x₀)), (x₁, f(x₁)) y
          (x₂, f(x₂)).
        </figcaption>
      </figure>
      ...
      <p className="text-gray-700">
        ...
        número de subdivisiones (siempre par) para ver cómo cambia el valor del área aproximada.
      </p>
    </section>
  );
}
